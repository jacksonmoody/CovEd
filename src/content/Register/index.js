...
const Register = () => {
    return (
        <div style={{display: "flex", minWidth:"80vw", minHeight:"100vh", alignContent:"center", justifyContent: "center", justifySelf:"center", justifyItems:"center", flexDirection: "column"}}>
            ...
            <div style = {{display: "flex", alignContent:"center", height: "50px", lineHeight: "50px", justifyContent: "center"}}><LinkStyled to="/register/csu" ver="default">Are you a student at a CSU campus? Click here to register to mentor!</LinkStyled> <LinkStyled to="https://www.calstate.edu/csu-system/csu-branding-standards/editorial-style-guide/Pages/campus-names.aspx" ver="default" target="_blank"> For a list of CSUs, click here. </LinkStyled></div>
