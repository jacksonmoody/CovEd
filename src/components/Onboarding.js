...
function Onboarding(props) {
    ...
    function handleOnboarding() {
        ...
        addUser(props.currentUser.uid, props.currentUser.type, props.currentUser.name, props.currentUser.authProvider, props.currentUser.email, image, true);
    }
