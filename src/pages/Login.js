...
function Login() {
    ...
    async function submit_normal(e) {
        e.preventDefault();
        loginWithEmailAndPassword(email, password, tabIndex);
    }
    ...
    return (
        <Container component="main" maxWidth="sm">
            ...
            <Box sx={{
                ...
                <Tabs value={tabIndex} onChange={handleTabChange} variant="fullWidth" sx={{ marginTop: 3 }} TabIndicatorProps={{
                    style: {
